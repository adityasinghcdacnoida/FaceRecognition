...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        video_capture = ("http://192.168.1.7/cgi-bin/snapshot.cgi")
        c = 0
        ...
        prevTime = 0
        while True:
            url_response = urllib.request.urlopen(video_capture)
            ...
            frame = cv2.resize(img, (0,0), fx=1.2, fy=1.2)    #resize frame (optional)
                ...
                if nrof_faces > 0:
                    ...
                    for i in range(nrof_faces):
                        ...
                        if best_class_probabilities>0.53:
                            cv2.rectangle(img, (bb[i][0], bb[i][1]), (bb[i][2], bb[i][3]), (0, 255, 0), 3)    #boxing face
